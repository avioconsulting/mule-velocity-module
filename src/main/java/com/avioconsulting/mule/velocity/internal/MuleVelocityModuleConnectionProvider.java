 ...
 */
public class MuleVelocityModuleConnectionProvider implements PoolingConnectionProvider<MuleVelocityModuleConnection> {

  private final Logger LOGGER = LoggerFactory.getLogger(MuleVelocityModuleConnectionProvider.class);
  ...
  @Override
  public MuleVelocityModuleConnection connect() throws ConnectionException {
    return new MuleVelocityModuleConnection(requiredParameter + ":" + optionalParameter);
  }

  @Override
  public void disconnect(MuleVelocityModuleConnection connection) {
    try {
  ...
  @Override
  public ConnectionValidationResult validate(MuleVelocityModuleConnection connection) {
